# Air Canvas with Hand Gesture Drawing
...
# Kernel for morphological operations (not used much here)
...
while ret:
    ...
    if result.multi_hand_landmarks:
        ...
        # Check if drawing mode (index close to thumb)
